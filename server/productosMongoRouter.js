...
router.get('/api/mongo/productos', async (req, res) =>{
...
router.get('/api/mongo/productos/:id', async (req, res)=> {
    const idReq = req.params.id
    const produtoId = await objProducto.getById(idReq);
    res.send(produtoId);
})

router.post('/api/mongo/productos', async (req, res) => {
...
router.put('/api/mongo/productos/:id', async (req, res) => {
...
router.delete('/api/mongo/productos/:id', async (req, res) => {
