...
import Contenedor from './daos/carritos/carritoDaoFirebase.js';

const router = express.Router();
const objCarrito = new Contenedor()

router.get('/api/firebase/carro', async (req, res) =>{
...
router.get('/api/firebase/carro/:id', async (req, res)=> {
    const idReq = req.params.id
    const carritoId = await objCarrito.getById(idReq);
    res.send(carritoId);
})

router.post('/api/firebase/carro', async (req, res) => {
...
router.put('/api/firebase/carro/:id', async (req, res) => {
...
router.delete('/api/firebase/carro/:id', async (req, res) => {
...
export {router as carritoFirebaseRouter}