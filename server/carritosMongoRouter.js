...
router.get('/api/mongo/carro', async (req, res) =>{
...
router.get('/api/mongo/carro/:id', async (req, res)=> {
    const idReq = req.params.id
    const carritoId = await objCarrito.getById(idReq);
    res.send(carritoId);
})

router.post('/api/mongo/carro', async (req, res) => {
...
router.put('/api/mongo/carro/:id', async (req, res) => {
...
router.delete('/api/mongo/carro/:id', async (req, res) => {
